...
<?php
	...
	$address = "IKGapirov@gmail.com";//адрес куда будет отсылаться сообщение для администратора
	...
	if ($send) //проверяем, отправилось ли сообщение
		echo "Сообщение отправлено успешно! Перейти на <a href='https://ikgapirov.github.io/tax-consulting/'>tax-consulting</a>, если вас не перенаправило вручную.";
	else 
